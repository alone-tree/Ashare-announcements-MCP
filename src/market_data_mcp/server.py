...
- get_financials:     原始财务报表（三表，多报告期 × 报表范围可选）
- get_indicators:     财务衍生指标（原始，多报告期）
- get_company_info:   公司基本信息（概况/分红/盈利预测，sections 可选）
...
def create_server() -> Any:
    ...
    def get_financials(
        ...
        """
        return _wrap(get_financials)(code=code, periods=periods, statements=statements)
    ...
    def get_indicators(
        ...
        """
        return _wrap(get_indicators)(code=code, periods=periods)
    ...
    def get_company_info(
        ...
        """
        return _wrap(get_company_info)(code=code, sections=sections)
